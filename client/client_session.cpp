...
namespace
{
    ...
    constexpr sl::message_info<Anticheat::KernelDataPageExecCheckRequest, sl::session> kernel_data_page_exec_check_request{
        Anticheat::ResponseId_KernelDataPageExecCheck,
